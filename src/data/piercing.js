...
export const PIERCING_PRICES = [
  { name: 'Один/два прокола у топ-мастера Виктории', price: '2 500₽ / 4 000₽' },
  { name: 'Один/два прокола у мастера Алексея', price: '2 000₽ / 3 000₽' },
  { name: 'Пирсинг сосков (два прокола)', price: '4 000₽' },
  { name: 'Генитальный пирсинг (только женский)', price: '4 000₽' },
  { name: 'Установка одного/двух микродермалов', price: '3 500₽ / 5 500₽' },
  { name: 'Чистка/удаление микродермала', price: '500₽ / 700₽' },
  { name: 'Восстановление прокола без иглы', price: '1 000₽' },
  { name: 'Осмотр/консультация по нашим проколам', price: '200-500₽' },
