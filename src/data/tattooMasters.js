...
export const TATTOO_PRICES = [
  { name: 'Небольшая татуировка до 5 см', price: 'от 4 000₽ до 8 000₽' },
  { name: '1 сеанс (3 часа работы)', price: 'от 9 000₽ до 19 000₽' },
  { name: 'Перекрытие старых тату/шрамов', price: 'от 17 000₽' },
  { name: 'Разработка индивидуального эскиза', price: 'от 2 000₽' },
];
